...
required to agree with and follow our [code of conduct]({% link pages/code-of-conduct.md %}),
...
[code of conduct]({% link pages/code-of-conduct.md %}) also provides other means of
reporting incidents.
...
Check the [agenda]({% link pages/agenda.md %}) or the announcements channel on Slack
